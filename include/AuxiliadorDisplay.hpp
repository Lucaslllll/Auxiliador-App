...
protected:
  ...
  // Box m_VBox, m_VBox2;
    ...
    Box m_box1, m_box2, m_box3, m_box4, m_box5, m_box6;
    ...
    Frame m_frame1, m_frame2, m_frame3, m_frame4, m_frame5, m_frame6;
    ...
    Grid m_grid, m_grid_lista, m_grid_opcoes, m_grid_adicionar;
